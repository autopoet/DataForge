...
const { copy: copyText } = useCopy({ source: textOutput, text: t('tools.base64-string-converter.decodedCopied') });
...
<template>
  <c-card :title="t('tools.base64-string-converter.encodeTitle')">
    ...
    <c-input-text
      :label="t('tools.base64-string-converter.encodedLabel')"
      :value="base64Output"
      multiline
      readonly
      :placeholder="t('tools.base64-string-converter.encodedPlaceholder')"
      rows="5"
      mb-5
    />
  ...
  <c-card :title="t('tools.base64-string-converter.decodeTitle')">
    ...
    <c-input-text
      ...
      multiline
      :placeholder="t('tools.base64-string-converter.decodeInputPlaceholder')"
      rows="5"
      :validation-rules="b64ValidationRules"
      :validation-watch="b64ValidationWatch"
      :label="t('tools.base64-string-converter.decodeInputLabel')"
      mb-5
    />
